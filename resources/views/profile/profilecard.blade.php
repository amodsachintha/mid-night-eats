<div class="card mb-3 shadow">
    <div class="pt-4 pl-4 pr-4">
        <img class="card-img-top img-thumbnail shadow" style="border-radius: 50%" src="/img/avatars/thumbnails/{{$user->avatar}}" alt="Card image" data-toggle="tooltip" data-placement="top" title="looking good 😍">
    </div>
    ...
    <div align="center" class="mb-3">
        ...
        <a href="{{route('profile.orders')}}" class="btn btn-primary btn-block w-75">My Orders <span
                    class="badge badge-pill badge-danger">{{$activeOrderCount > 0 ? $activeOrderCount : ''}}</span></a>
